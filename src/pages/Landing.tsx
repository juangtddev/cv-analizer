  ...
  const features = [
    {
      ...
      description:
        'IA avançada analisa seu currículo e fornece insights detalhados para melhorar suas chances de contratação.',
    },
    {
      icon: TrendingUp,
      title: 'Acompanhamento de Progresso',
      description:
        'Monitore a evolução do seu currículo ao longo do tempo com métricas e gráficos detalhados.',
    },
    {
      icon: FileText,
      title: 'Múltiplos Formatos',
      description:
        'Suporte para PDF, Word e integração com LinkedIn para análise completa do seu perfil.',
    },
    {
      icon: Users,
      title: 'Comparação com Vagas',
      description:
        'Compare seu currículo com vagas específicas e receba sugestões personalizadas.',
    },
  ];
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Receba análises detalhadas, sugestões personalizadas e acompanhe
              sua evolução profissional com nossa plataforma inteligente de
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-xl text-gray-600 mb-8">
                  ...
                  fornecer insights precisos e actionáveis sobre seu currículo.
                </p>
        ...
        <section className="bg-gradient-to-r from-blue-600 to-purple-600 py-20">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Junte-se a milhares de profissionais que já otimizaram seus
              currículos com nossa IA.
            </p>
            <Button
              size="lg"
              variant="secondary"
